...
const addItemToCart=async(product,dispatchCart,setButtonText,cartCount)=>{
    try{
...
const addItemToWishlist=async(product,dispatchWishlist,setToWishlist,wishlistCount)=>{
  try{
...
const removeItemFromWishlist=async(product,dispatchWishlist,setToWishlist,wishlistCount)=>{
  try{
  ...
  export {addItemToCart,gotoCart,addItemToWishlist,removeItemFromWishlist,gotoWishlist,removeItemFromCart}